...
function rc_showMesages(){
	...
	$('.required').each(function(index){		
		...
		/* inputs */
		if($(this).find('.pp-input').val().trim() == '' && $(this).find('.pp-input').hasClass('save')){
		...
		/* selects */
		if($(this).find('.pp-select').val().trim() == '' && $(this).find('.pp-input').hasClass('save')){
			$(this).addClass('pp-error');
...
function rc_showMesagesGrid(id){
	...
	$('#'+id).find('.required').each(function(index){		
		...
		/* inputs */
		if($(this).find('.pp-input').val().trim() == '' ){
			$(this).addClass('pp-error');
		...
		/* selects */
		if($(this).find('.pp-select').val().trim() == '' ){
			$(this).addClass('pp-error');
